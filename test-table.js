...
/************ Background ************/ 
.WHITE_FLAT_THEME .new-dashboard{padding:15px 0px 0px 0px !important;}
.WHITE_FLAT_THEME #pageData{padding:0px !important;  background-size:cover;  background:radial-gradient( #e0e0e0, #515867 );  }
.WHITE_FLAT_THEME .grid-container{ height: `+gridHeight+`; margin:75px 100px; background-color:#f2f2f2; box-shadow:0px 0px 8px 2px rgba(0, 0, 0, 0.25); 
border-radius:10px; border:0px solid #ccc; overflow:hidden;}
...
.WHITE_FLAT_THEME .new-widget:not(.type-generic-timeline) .widget_table .k-grid-content .highligulesCell {height: 20px;}

/******* Crosss Table Format ******/
.WHITE_FLAT_THEME .controll_container{ background-color:#fff;}
.WHITE_FLAT_THEME table.pvtTable tr {height: 300px;}
